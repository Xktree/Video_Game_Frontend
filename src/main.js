...
// (10 points) As a developer, I want to utilize the Java Spring Rest API controller and service layers to store my endpoints. (DONE)

// - Endpoint: GET request to get all video game records (DONE)

// - Endpoint: GET request to get a single video game record by ID (DONE)

// (5 points) As a developer, I want to create a React.js application to consume and visualize the Spring Rest API video game API data. (DONE)
